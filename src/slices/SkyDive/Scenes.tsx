...
export default function Scenes({ sentence, flavor }: SkyDiveProps) {
...
function ThreeText({
  ...
  return words.map((word: string, wordInd: number) => (
    <Text
      ...
      anchorX={"center"}
      anchorY={"middle"}
      characters="ABCDEFGHIJKLMNOPQRSWXYZ!,.?"
      key={`${wordInd}-${word}`}
    >
      {word}
    </Text>
